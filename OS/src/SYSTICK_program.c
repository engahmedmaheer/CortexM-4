...
void SYSTICK_voidSynchSecondsDelay(uint32 local_uint32Seconds)
{
	...
	{
#if SYSTICK_CLOCK_SOURCE == AHB_DIV_8
		SYSTICK -> LOAD.R =(SYSTICK_SYSTEM_FREQ)/8 ;
#elif SYSTICK_CLOCK_SOURCE == AHB
		SYSTICK -> LOAD.R =(SYSTICK_SYSTEM_FREQ);
#endif
...
void SYSTICK_voidSynchMsecondsDelay(uint32 local_uint32MilliSeconds)
{
	...
	//	SYSTICK -> LOAD.R = 3125;
#if SYSTICK_CLOCK_SOURCE == AHB_DIV_8
		SYSTICK -> LOAD.R =(SYSTICK_SYSTEM_FREQ)/8000 ;
#elif SYSTICK_CLOCK_SOURCE == AHB
		SYSTICK -> LOAD.R =(SYSTICK_SYSTEM_FREQ)/1000;
#endif
		SYSTICK -> CTRL.B.ENABLE = 1;
		while(SYSTICK -> CTRL.B.COUNTFLAG == 0);
		SYSTICK -> CTRL.B.COUNTFLAG = 0;
...
void SYSTICK_voidSynchUsecondsDelay(uint32 local_uint32MicroSeconds)
{
	...
	//	SYSTICK -> LOAD.R = 3;
#if SYSTICK_CLOCK_SOURCE == AHB_DIV_8
		SYSTICK -> LOAD.R =(SYSTICK_SYSTEM_FREQ)/8000000 ;
#elif SYSTICK_CLOCK_SOURCE == AHB
		SYSTICK -> LOAD.R =(SYSTICK_SYSTEM_FREQ)/1000000;
#endif
...
{
	return ((SYSTICK -> VALUE.R) - (SYSTICK -> LOAD.R));
}
